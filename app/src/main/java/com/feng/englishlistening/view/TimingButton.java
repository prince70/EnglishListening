...
//                        setText(text1 + count-- + ")");
                        setText( count-- + "S");
                        setTextColor(getResources().getColor(R.color.abus_white));
    ...
    public void startTiming() {
        ...
        setPadding(0, 0, 0, 0);
        setLayoutParams(lp);
        setBackground(getResources().getDrawable(R.drawable.sms_gray_bg_xml));
        setEnabled(false);
        count = TIME_SECONDS;
    ...
    public void enableButton() {
        ...
        setEnabled(true);
        setText(text);
        setTextColor(getResources().getColor(R.color.abus_blue));
        setBackground(getResources().getDrawable(R.drawable.sms_bg_xml));
    }
