package com.feng.englishlistening.view;
...
public class ActivityHeaderView extends LinearLayout implements OnClickListener {
    ...
    private void init(Context con, AttributeSet attr) {
        ...
        View v = LayoutInflater.from(con).inflate(R.layout.activity_header_view, this);
        ...
        if (hideBackButton) {
            ...
            imgBack.setImageResource(R.mipmap.back_white);
        } else {
            setLeftImage(R.mipmap.back_white);
        }
    ...
    public void setBackGroupImg(int resId) {
        headContentLayout.setBackgroundResource(resId);
    }
    ...
    public void setTitle(String text) {
        ...
        tvTitle.setTextColor(getResources().getColor(R.color.abus_white));
    }
