package com.feng.englishlistening.utils;
...
public class SharedPreferencesTools {
    public static final String PREFERENCES_NAME = "feng_map";
    ...
    public static void saveDataJson(Context con, String key, JSONObject jsonObj) {
        if (TextUtils.isEmpty(key)) {
            return;
        }
        saveSysMap(con, key, jsonObj.toString());
    }
